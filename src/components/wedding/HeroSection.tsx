...
const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 pb-24 md:pt-28 md:pb-28 bg-gradient-to-b from-[hsl(38,65%,45%)] via-[hsl(35,50%,55%)] to-[hsl(35,45%,90%)]">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center mb-8 opacity-0 animate-fade-up">
          <img 
            ...
            style={{ filter: 'sepia(100%) saturate(600%) brightness(55%) hue-rotate(-30deg) contrast(1.2)' }}
          />
        </div>
